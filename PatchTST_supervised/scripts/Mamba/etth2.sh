...
for random_seed in 2024 #2023 42 1107 2025
do
  for ch_ind in 0 1
  do
    if [ $ch_ind == 0 ]
...
#          --pct_start 0.2\
#          --gpu ${gpu} \
#          --itr 1 --batch_size 256 --learning_rate 0.0001 2>&1 | tee logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
#    done
#
#    for pred_len in 192
#    do
